	...
	>
		...
		>
			{["top", "right", "bottom", "left"].map((side) => (
				<div key={side}>
					<TextControl
						label={__(side.toUpperCase(), "clean-kerala-project")}
						value={values?.[side] || ""}
						type="number"
	...
	useEffect(() => {
		...
		if (!blockId) {
			initialUpdates.blockId =
				"oone-multi-content-modern-carousel-" +
				Date.now() +
				"-" +
		...
		setAttributes({
			slides: [
				...slides,
				{
					...
					link: "",
					image:
						"oone-carousel-image-holistic-strategy.webp",
					imgAlt: "",
				},
			],
		});
								...
								{tab.name === "layout" && (
									<div style={{ marginTop: "20px", marginBottom: "10px" }}>
										...
										<div>
											...
											>
												{__("Padding (px)", "clean-kerala-project")}
											</label>
											<BoxModelControls
												type="padding"
												values={padding}
										...
										<div>
											...
											>
												{__("Mobile Padding (px)", "clean-kerala-project")}
											</label>
											<BoxModelControls
												type="mobilePadding"
										...
										{progressbar && (
											<div style={{ marginBottom: "15px" }}>
												...
												<Button
													...
													style={{
														background:
															resolveColor(progressbarColor) || "#333",
														color: "#FFFFFF",
														textShadow: "1px 1px 2px rgba(0, 0, 0, 0.9)",
														border: "1px solid #ddd",
														padding: "8px 16px",
												...
												>
													...
													<div style={{ marginBottom: "15px" }}>
														...
														<Button
															...
															style={{
																// FIX: Access slide.filterColor, not the global filterColor
																background:
														...
														{activeColorPicker === `filterColor-${index}` && (
															...
															>
																...
																/>
																<ColorPicker
																	// FIX: Ensure we resolve the specific slide's color
																	color={resolveColor(
																		slide.filterColor || "transparent",
																	)}
																	onChangeComplete={(color) =>
